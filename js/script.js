...
// Seleziono l'elemento tramite InnerHTML
document.innerHTML=getElementById('.carousel-images');
...
for (let index = 0; index < images.length; index++) {
    ...
    console.log(images);
    // Creo un template da popolare

    let cardAdd = `<div class= "carousel-card">
    <div class= "card-image">
      <img 
       ...
       alt= "${element.name}"/>
        ...
        carousel-images.innerHTML +=  cardAdd;
